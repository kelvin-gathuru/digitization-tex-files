...
\modulename{Mathematical Preliminaries and Solutions of One Variable Equations}
...
\mddescription
In this module you are carried through introductory remark on numerical methods. You are then guided into a comprehensive discussion of computer arithmetic and some methods of numerical solutions of equations of one variable. In particular, you will learn about:
\begin{itemize}
...
\begin{table}
\centering
\includegraphics[ width=15cm]{Bisectionmethodexampletable.jpeg}
...
\begin{itemize}
\item Describe in your own words new knowledge you have acquired in this module.
\end{itemize}
